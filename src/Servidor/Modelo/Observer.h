...
typedef struct spawn_object spawn_object_t ;
...
public:
    ...
    virtual void notifySpawnNpcUpdate(std::vector<spawn_object_t> &npcs) = 0;
    ...
    virtual void
    notifyCityCharactersSpawn(std::vector<spawn_object> &spawns) = 0;
    virtual void notifyDropSpawnNUpdate(std::vector<spawn_object_t> dropSpawns) = 0;
